...
public class ItemsMenu {
    ...
    public static ArrayList<ListModelMenu> customListViewFarmer = new ArrayList<ListModelMenu>(){{
        add(new ListModelMenu(R.string.txt_menu_news, R.drawable.bt_menu_news));
    ...
    public static ArrayList<ListModelMenu> getCustomListViewFarmer(){
        return customListViewFarmer;
    }
